// src/lib.rs
/*
 * Core library for ScribbleMoralis
 */
...
#[derive(Debug)]
pub struct ScribbleMoralisProcessor {
    verbose: bool,
    processed_count: usize,
}

impl ScribbleMoralisProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting ScribbleMoralis processing");
    
    let mut processor = ScribbleMoralisProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = ScribbleMoralisProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = ScribbleMoralisProcessor::new(false);
